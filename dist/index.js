...
import { handleUserSignUp, handleListMyReviews, handleListMyMissions, handleUserMissionComplete, updateUserInfo } from "./controllers/user.controller.js";
...
app.get("/api/v1/restaurant/:restaurantId/missions", handleListRestaurantMissions); //특정 가게 미션 목록 엔드포인트
